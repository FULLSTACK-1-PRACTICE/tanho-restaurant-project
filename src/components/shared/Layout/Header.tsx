    ...
    >
      <Container>
        <div className="flex h-[76px] items-center justify-between">
          <Link
            to="/"
            className="flex items-center justify-center shrink-0 cursor-pointer h-[50px] w-[140px] relative overflow-hidden"
          >
            <img
              src={logo}
              alt="Tanho Restaurant"
              className="h-[100px] max-w-none w-auto object-contain block -mt-1"
            />
          </Link>
